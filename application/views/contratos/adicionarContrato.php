            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="tipo" id="tipo" class="span12" required>
                                ...
                                <option value="variavel">Honorário Variável</option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="date" name="data_inicio" value="<?= date('Y-m-d') ?>" class="span12" required>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="date" name="data_fim" class="span12">
                            <span class="help-block">Deixe em branco para contrato indeterminado</span>
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="valor_fixo_group">
                        ...
                        <div class="controls">
                            <input type="text" name="valor_fixo" id="valor_fixo" class="span12 money" placeholder="0,00">
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="percentual_sucumbencia_group" style="display:none;">
                        ...
                        <div class="controls">
                            <input type="number" name="percentual_sucumbencia" id="percentual_sucumbencia" 
                                class="span12" step="0.01" min="0" max="100" placeholder="Ex: 20.00">
                        </div>
                    </div>
                    ...
                    <div class="control-group" id="percentual_exito_group" style="display:none;">
                        ...
                        <div class="controls">
                            <input type="number" name="percentual_exito" id="percentual_exito" 
                                class="span12" step="0.01" min="0" max="100" placeholder="Ex: 30.00">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="observacoes" class="span12" rows="4"></textarea>
                        </div>
                    </div>

                    <div class="form-actions">
                        <button type="submit" class="button btn btn-success">Salvar</button>
