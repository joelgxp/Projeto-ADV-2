                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="hora" type="time" name="hora" value="<?php echo set_value('hora', '09:00'); ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="local" type="text" name="local" value="<?php echo set_value('local'); ?>" placeholder="Ex: Fórum, Sala, Vara..." />
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <button type="submit" class="button btn btn-mini btn-success">
                                ...
                                <span class="button__text2">Salvar Audiência</span>
                            </button>
