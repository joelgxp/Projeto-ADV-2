    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <h5>Cadastro de Processo Judicial</h5>
            </div>
            <?php if ($custom_error != '') {
                ...
                <div class="widget-content nopadding tab-content">
                            ...
                            <div class="controls">
                                <div class="numero-cnj-container">
                                    <input id="numeroProcesso" type="text" name="numeroProcesso" 
                                        ...
                                        value="<?php echo set_value('numeroProcesso'); ?>" required />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="tribunal" name="tribunal">
                                    ...
                                    <option value="TJ" <?= set_value('tribunal') == 'TJ' ? 'selected' : '' ?>>TJ - Tribunal de Justiça</option>
                                    <option value="TRF" <?= set_value('tribunal') == 'TRF' ? 'selected' : '' ?>>TRF - Tribunal Regional Federal</option>
                                    <option value="TRT" <?= set_value('tribunal') == 'TRT' ? 'selected' : '' ?>>TRT - Tribunal Regional do Trabalho</option>
                                    <option value="TRE" <?= set_value('tribunal') == 'TRE' ? 'selected' : '' ?>>TRE - Tribunal Regional Eleitoral</option>
                                    <option value="STJ" <?= set_value('tribunal') == 'STJ' ? 'selected' : '' ?>>STJ - Superior Tribunal de Justiça</option>
                                    <option value="STF" <?= set_value('tribunal') == 'STF' ? 'selected' : '' ?>>STF - Supremo Tribunal Federal</option>
                                    <option value="TST" <?= set_value('tribunal') == 'TST' ? 'selected' : '' ?>>TST - Tribunal Superior do Trabalho</option>
                                    <option value="TSE" <?= set_value('tribunal') == 'TSE' ? 'selected' : '' ?>>TSE - Tribunal Superior Eleitoral</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="segmento" name="segmento">
                                    <option value="">Selecione...</option>
                                    <option value="1" <?= set_value('segmento') == '1' ? 'selected' : '' ?>>Supremo Tribunal Federal (STF)</option>
                                    <option value="2" <?= set_value('segmento') == '2' ? 'selected' : '' ?>>Conselho Nacional de Justiça (CNJ)</option>
                                    <option value="3" <?= set_value('segmento') == '3' ? 'selected' : '' ?>>Superior Tribunal de Justiça (STJ)</option>
                                    <option value="4" <?= set_value('segmento') == '4' ? 'selected' : '' ?>>Justiça Federal</option>
                                    <option value="5" <?= set_value('segmento') == '5' ? 'selected' : '' ?>>Justiça do Trabalho</option>
                                    <option value="6" <?= set_value('segmento') == '6' ? 'selected' : '' ?>>Justiça Eleitoral</option>
                                    <option value="7" <?= set_value('segmento') == '7' ? 'selected' : '' ?>>Justiça Militar da União</option>
                                    <option value="8" <?= set_value('segmento') == '8' ? 'selected' : '' ?>>Justiça Estadual</option>
                                    <option value="9" <?= set_value('segmento') == '9' ? 'selected' : '' ?>>Justiça Militar Estadual</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="vara" type="text" name="vara" placeholder="Vara" value="<?php echo set_value('vara'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="comarca" class="control-label">Comarca</label>
                            <div class="controls">
                                <input id="comarca" type="text" name="comarca" placeholder="Comarca" value="<?php echo set_value('comarca'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="classe" name="classe">
                                    <option value="">Selecione...</option>
                                    <option value="Ação de Cobrança" <?= set_value('classe') == 'Ação de Cobrança' ? 'selected' : '' ?>>Ação de Cobrança</option>
                                    <option value="Ação de Despejo" <?= set_value('classe') == 'Ação de Despejo' ? 'selected' : '' ?>>Ação de Despejo</option>
                                    <option value="Ação de Indenização" <?= set_value('classe') == 'Ação de Indenização' ? 'selected' : '' ?>>Ação de Indenização</option>
                                    <option value="Ação Trabalhista" <?= set_value('classe') == 'Ação Trabalhista' ? 'selected' : '' ?>>Ação Trabalhista</option>
                                    <option value="Ação Previdenciária" <?= set_value('classe') == 'Ação Previdenciária' ? 'selected' : '' ?>>Ação Previdenciária</option>
                                    <option value="Ação de Família" <?= set_value('classe') == 'Ação de Família' ? 'selected' : '' ?>>Ação de Família</option>
                                    <option value="Ação Criminal" <?= set_value('classe') == 'Ação Criminal' ? 'selected' : '' ?>>Ação Criminal</option>
                                    <option value="Mandado de Segurança" <?= set_value('classe') == 'Mandado de Segurança' ? 'selected' : '' ?>>Mandado de Segurança</option>
                                    <option value="Habeas Corpus" <?= set_value('classe') == 'Habeas Corpus' ? 'selected' : '' ?>>Habeas Corpus</option>
                                    <option value="Outros" <?= set_value('classe') == 'Outros' ? 'selected' : '' ?>>Outros</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="assunto" name="assunto">
                                    <option value="">Selecione...</option>
                                    <option value="Contratos" <?= set_value('assunto') == 'Contratos' ? 'selected' : '' ?>>Contratos</option>
                                    <option value="Danos Morais" <?= set_value('assunto') == 'Danos Morais' ? 'selected' : '' ?>>Danos Morais</option>
                                    <option value="Danos Materiais" <?= set_value('assunto') == 'Danos Materiais' ? 'selected' : '' ?>>Danos Materiais</option>
                                    <option value="FGTS" <?= set_value('assunto') == 'FGTS' ? 'selected' : '' ?>>FGTS</option>
                                    <option value="Férias" <?= set_value('assunto') == 'Férias' ? 'selected' : '' ?>>Férias</option>
                                    <option value="13º Salário" <?= set_value('assunto') == '13º Salário' ? 'selected' : '' ?>>13º Salário</option>
                                    <option value="Pensão Alimentícia" <?= set_value('assunto') == 'Pensão Alimentícia' ? 'selected' : '' ?>>Pensão Alimentícia</option>
                                    <option value="Guarda" <?= set_value('assunto') == 'Guarda' ? 'selected' : '' ?>>Guarda</option>
                                    <option value="Divórcio" <?= set_value('assunto') == 'Divórcio' ? 'selected' : '' ?>>Divórcio</option>
                                    <option value="Outros" <?= set_value('assunto') == 'Outros' ? 'selected' : '' ?>>Outros</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="dataDistribuicao" type="date" name="dataDistribuicao" value="<?php echo set_value('dataDistribuicao'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="valorCausa" type="text" name="valorCausa" 
                                    placeholder="0,00" 
                                    value="<?php echo set_value('valorCausa'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="status" name="status" required>
                                    <option value="em_andamento" <?= set_value('status', 'em_andamento') == 'em_andamento' ? 'selected' : '' ?>>Ativo</option>
                                    <option value="arquivado" <?= set_value('status') == 'arquivado' ? 'selected' : '' ?>>Arquivado</option>
                                    <option value="finalizado" <?= set_value('status') == 'finalizado' ? 'selected' : '' ?>>Encerrado</option>
                                    <option value="suspenso" <?= set_value('status') == 'suspenso' ? 'selected' : '' ?>>Suspenso</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <div class="span6">
                            ...
                            <div class="controls">
                                <div class="partes-container">
                                    ...
                                    <div class="parte-box">
                                        ...
                                        <div id="partesAtivo">
                                            <!-- Partes serão adicionadas dinamicamente aqui -->
                                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea id="observacoes" name="observacoes" rows="8" class="span12" placeholder="Informações adicionais sobre o processo..."><?php echo set_value('observacoes'); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    var contadorPartes = { ativo: 0, passivo: 0 };
    ...
    $(document).ready(function() {
        ...
        // Restaurar partes em caso de erro de validação
        // Limpar partes existentes primeiro para evitar duplicação
        console.log('Iniciando restauração de partes...');
        console.log('Container #partesAtivo existe?', $('#partesAtivo').length > 0);
        console.log('Container #partesPassivo existe?', $('#partesPassivo').length > 0);
        
        if (Array.isArray(partesAtivoRestaurar) && partesAtivoRestaurar.length > 0) {
            console.log('Restaurando', partesAtivoRestaurar.length, 'parte(s) do polo ativo');
            $('#partesAtivo').empty();
            partesAtivoRestaurar.forEach(function(parte, index) {
                if (parte && (parte.nome || parte.clientes_id)) {
                    ...
                    if (nome || clientes_id) {
                        ...
                        console.log('Parte ativo restaurada:', nome);
                    }
                }
            });
            console.log('Total de partes ativo restauradas:', $('#partesAtivo .parte-item').length);
        } else {
            console.log('Nenhuma parte ativo para restaurar');
        }
        
        if (Array.isArray(partesPassivoRestaurar) && partesPassivoRestaurar.length > 0) {
            console.log('Restaurando', partesPassivoRestaurar.length, 'parte(s) do polo passivo');
            $('#partesPassivo').empty();
            partesPassivoRestaurar.forEach(function(parte, index) {
                if (parte && (parte.nome || parte.clientes_id)) {
                    ...
                    if (nome || clientes_id) {
                        ...
                        console.log('Parte passivo restaurada:', nome);
                    }
                }
            });
            console.log('Total de partes passivo restauradas:', $('#partesPassivo .parte-item').length);
        } else {
            console.log('Nenhuma parte passivo para restaurar');
        }
    ...
    function atualizarAdvogadosLista() {
        ...
        advogadosAdicionados.forEach(function(adv) {
            ...
            var html = '<div class="advogado-item" id="advogado-' + adv.indice + '">' +
                ...
                '</div>' +
                '<button type="button" class="btn-remove-advogado" onclick="removerAdvogado(' + adv.indice + ')">' +
                    '<i class="bx bx-trash"></i> Remover' +
                '</button>' +
            '</div>';
    ...
    // Carregar advogados do POST quando a página carregar
    $(document).ready(function() {
