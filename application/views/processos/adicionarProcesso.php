                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="numeroProcesso" type="text" name="numeroProcesso" 
                                    ...
                                    value="<?php echo set_value('numeroProcesso'); ?>" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="classe" type="text" name="classe" value="<?php echo set_value('classe'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="tipo_processo" name="tipo_processo">
                                    ...
                                    <option value="civel" <?= set_value('tipo_processo') == 'civel' ? 'selected' : '' ?>>Cível</option>
                                    <option value="trabalhista" <?= set_value('tipo_processo') == 'trabalhista' ? 'selected' : '' ?>>Trabalhista</option>
                                    <option value="tributario" <?= set_value('tipo_processo') == 'tributario' ? 'selected' : '' ?>>Tributário</option>
                                    <option value="criminal" <?= set_value('tipo_processo') == 'criminal' ? 'selected' : '' ?>>Criminal</option>
                                    <option value="familia" <?= set_value('tipo_processo') == 'familia' ? 'selected' : '' ?>>Família</option>
                                    <option value="consumidor" <?= set_value('tipo_processo') == 'consumidor' ? 'selected' : '' ?>>Consumidor</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="vara" type="text" name="vara" value="<?php echo set_value('vara'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="comarca" class="control-label">Comarca</label>
                            <div class="controls">
                                <input id="comarca" type="text" name="comarca" value="<?php echo set_value('comarca'); ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="tribunal" class="control-label">Tribunal</label>
                            <div class="controls">
                                <input id="tribunal" type="text" name="tribunal" value="<?php echo set_value('tribunal'); ?>" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="segmento" name="segmento">
                                    <option value="">Selecione...</option>
                                    <option value="estadual" <?= set_value('segmento') == 'estadual' ? 'selected' : '' ?>>Estadual</option>
                                    <option value="federal" <?= set_value('segmento') == 'federal' ? 'selected' : '' ?>>Federal</option>
                                    <option value="trabalho" <?= set_value('segmento') == 'trabalho' ? 'selected' : '' ?>>Trabalho</option>
                                    <option value="eleitoral" <?= set_value('segmento') == 'eleitoral' ? 'selected' : '' ?>>Eleitoral</option>
                                    <option value="militar" <?= set_value('segmento') == 'militar' ? 'selected' : '' ?>>Militar</option>
                                </select>
                                <small class="help-inline">Será preenchido automaticamente pelo número do processo</small>
                            </div>
                        </div>
                    ...
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="status" name="status">
                                    <option value="em_andamento" <?= set_value('status', 'em_andamento') == 'em_andamento' ? 'selected' : '' ?>>Em Andamento</option>
                                    ...
                                    <option value="finalizado" <?= set_value('status') == 'finalizado' ? 'selected' : '' ?>>Finalizado</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                                ...
                                <select id="clientes_id" name="clientes_id">
                                    ...
                                    if (isset($clientes) && $clientes) {
                                        ...
                                        foreach ($clientes as $cliente) {
                                            ...
                                            $selected = set_value('clientes_id') == $cliente_id ? 'selected' : '';
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea id="observacoes" name="observacoes" rows="5" class="span12"><?php echo set_value('observacoes'); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-actions">
                    <div class="span12">
                        <div class="span6 offset3" style="display:flex;justify-content: center">
                            <button type="submit" class="button btn btn-success"><span class="button__icon"><i class='bx bx-save'></i></span><span class="button__text2">Adicionar Processo</span></button>
