...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the adv version in the config filename
    ...
    /**
     * Get adv current version.
     *
     * @return string Adv current version.
     */
    private function getCurrentVersion()
    {
        ...
        if (! $version) {
            throw new Exception('Error getting adv version from GitHub!');
        }
