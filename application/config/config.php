 ...
 * Nome do sistema
 */
$config['app_name'] = $_ENV['APP_NAME'] ?? 'Adv';

/**
 * Descrição do sistema
 */
$config['app_subname'] = $_ENV['APP_SUBNAME'] ?? 'Sistema de Gestão Jurídica';
...
$config['csrf_token_name'] = $_ENV['APP_CSRF_TOKEN_NAME'] ?? 'ADV_TOKEN';
